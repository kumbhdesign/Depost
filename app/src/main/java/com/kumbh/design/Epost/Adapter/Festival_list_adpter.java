...
public class Festival_list_adpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    private List<constant> festivallist;
    String id;
    Intent i;
    ...
    public Festival_list_adpter(Context context, List<constant> festivallist, String id) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        if(holder.getItemViewType() == 1) {
            ...
            final constant festival = festivallist.get(position);
            vh1.Title.setText(festival.getFestival_name());
            ...
            vh1.festival_id.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(Integer.parseInt(id) == 1) {
                        Intent intent = new Intent(context, Set_Images.class);
                        intent.putExtra("festival", festival.getFestival_name().replace(" ", "+").replace("'", "%27"));
            ...
            vh1.bday_nt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Add_Birthday(mac_id,"birthday","REMINDER",festival.getFestival_name(),parseDateToddMMyyyy1(festival.getDate()),"00:01");
