...
public class Festival_list_page_premium extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks,
    ...
    AdView adView;
    AdRequest adRequest;
    final List<ListPostItem> list = new ArrayList<>();
...
//        });
    ...
    private void getData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, "https://www.kumbhdesign.in/mobile-app/depost/api/allpost", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                hide_dialog();
                    ...
                    if (jsonArray != null && jsonArray.length() > 0) {
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            list.add(new ListPostItem(object1.getString("date"), object1.getString("post_id"), object1.getString("cat_name"), object1.getString("post_name"), object1.getString("post_image_path"), object1.getString("cate_id")));
                        }


                        Festival_Adapter adapter = new Festival_Adapter(Festival_list_page_premium.this, list, id);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Festival_list_page_premium.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }
        );
...
//                        festivallist.add(c);
//                    }
//                    Festival_Adapter adapter = new Festival_Adapter(Festival_list_page.this, festivallist, id);
//                    recyclerView.setAdapter(adapter);
//                    recyclerView.setVisibility(View.VISIBLE);
//                    include.setVisibility(View.GONE);
//
...
//                    startActivityForResult(((UserRecoverableAuthIOException) mLastError).getIntent(), Festival_list_page.REQUEST_AUTHORIZATION);
//                } else {
//
//                }
//            } else {
//                Toast.makeText(Festival_list_page.this, "Request cancelled.", Toast.LENGTH_LONG).show();
//            }
//        }
//    }
...
//    }
    ...
    private void showGooglePlayServicesAvailabilityErrorDialog(int connectionStatusCode) {
        ...
        Dialog dialog = apiAvailability.getErrorDialog(
                Festival_list_page_premium.this,
    ...
    public void onPermissionsGranted(int requestCode, List<String> perms) {
        Toast.makeText(Festival_list_page_premium.this, "Permission Granted....", Toast.LENGTH_LONG).show();
        getData();
    }
    ...
    public void onBackPressed() {
        Intent i = new Intent(Festival_list_page_premium.this, HomrPage.class);
        startActivity(i);
        finish();
    }
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.loveu_1:
                i = new Intent(Festival_list_page_premium.this, Set_Images.class);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.menuLogout:
                        signOut(Festival_list_page_premium.this);
                        break;
